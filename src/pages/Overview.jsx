  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 pb-6 border-b border-white/[0.08]">
        ...
        <Link
          to="/connections"
          className="self-start md:self-auto px-5 py-2.5 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-500 hover:opacity-90 shadow-lg shadow-indigo-500/25 flex items-center gap-2 transition-all"
        >
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-[#0d101c]/90 backdrop-blur-xl border border-white/[0.08] shadow-2xl shadow-indigo-950/30">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-[#0d101c]/90 backdrop-blur-xl border border-white/[0.08] shadow-2xl">
          <div className="mb-6">
      ...
      <div className="p-8 rounded-3xl bg-gradient-to-r from-indigo-950/40 via-purple-950/30 to-pink-950/40 border border-indigo-500/30 flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
        <div>
        ...
        <Link
          to="/connections"
          className="px-6 py-3 rounded-2xl text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-500 shadow-xl shadow-indigo-600/30 transition-all shrink-0 flex items-center gap-2"
        >
